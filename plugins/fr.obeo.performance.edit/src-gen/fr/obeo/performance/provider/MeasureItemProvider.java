...
/**
 * This is the item provider adapter for a {@link fr.obeo.performance.Measure} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
        ...
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 ...
                 PerformancePackage.Literals.MEASURE__NAME,
                 true,
                 false,
                 false,
    ...
    protected void addDimensionPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_Measure_dimension_feature"),
                 getString("_UI_PropertyDescriptor_description", "_UI_Measure_dimension_feature", "_UI_Measure_type"),
                 PerformancePackage.Literals.MEASURE__DIMENSION,
                 true,
                 false,
                 false,
                 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
    ...
    protected void addValuePropertyDescriptor(Object object) {
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_Measure_value_feature"),
                 getString("_UI_PropertyDescriptor_description", "_UI_Measure_value_feature", "_UI_Measure_type"),
                 PerformancePackage.Literals.MEASURE__VALUE,
                 true,
                 false,
                 false,
